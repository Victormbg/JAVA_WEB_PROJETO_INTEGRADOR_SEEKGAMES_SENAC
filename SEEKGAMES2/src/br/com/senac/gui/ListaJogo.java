...
public class ListaJogo extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try{
            ...
            jogoController controller = new jogoController();
            jogo jogo = controller.buscarJogo(id);

            CadastroJogo form = new CadastroJogo(jogo);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        String[] colunas = {"id","Nome","Plataforma","Desenvolvedora","Grupo","Situacao","IdadeRecomendada","Preco"};
